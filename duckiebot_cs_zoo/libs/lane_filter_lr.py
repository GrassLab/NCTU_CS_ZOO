...
"""
LaneFilterLR: Left-Right Lane Filter
...
class LaneFilterLR:  # For Left and Right lane
    def __init__(self, homography_mat):
        self.params = LaneFilterParamsLR()
    ...
    def generate_votes(self, detections):
        # Currently only consider green and blue lanes
        votes_phi = []
        votes_d = []
            ...
            if color in self.params.color_used and dt is not None:
                ...
                if len(valid_indices) > 0:
                    ...
                    **A normal vector is heading directly to it's corresponding color chunk.**
                    ...
                    if color == 'green':  # Left side lane color
                    ...
                    elif color == 'blue':  # Right side lane color
