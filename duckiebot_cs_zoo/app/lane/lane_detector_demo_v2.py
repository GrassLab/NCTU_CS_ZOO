...
def lane_detection_pipeline_single():
    ...
    img_comb = improc.color_balance(rect_img_comb, percent=percent, clip_low=False,
                                    clip_high=True)  # TODO V2:Decide your parameters, same as the choice for img, img_comb is only for one-time use in the next step
