...
def lane_detection_pipeline_single():
    ...
    COLOR_BALANCE_FILE = 'my_balance.pkl'  # TODO: decide your filename
    """
    ...
    img = b1  # TODO: decide your parameters (b1 or b2 or b3 and keep their clip_low/clip_high settings in the next line)
    luts = improc.calculate_color_balance(rect_img, percent=percent, clip_low=False,
