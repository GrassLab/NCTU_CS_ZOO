...
def run_image_collect():
    ...
    DEFAULT_DATA_PATH = osp.join(osp.dirname(osp.dirname(osp.abspath(__file__))), 'data', 'camera_calibration')
    collect_camera_calibration_chessboard(client.camera, 0.031, (8, 6), DEFAULT_DATA_PATH)
